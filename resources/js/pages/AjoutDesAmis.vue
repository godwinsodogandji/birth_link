...
<form class="max-w-md mx-auto w-full mb-4 p-5">   
    ...
    <div class="relative">
        ...
        <input  v-model="searchQuery" type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-white-300 rounded-lg bg-white-50 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-wite-600 dark: placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"   placeholder="Rechercher un utilisateur..." required />
        ...
        <div class="mt-9 flex items-center">
            <button @click="prevPage" :disabled="currentPage === 1" class="px-4 py-2 bg-red-600 text-white rounded-l">
                Previous
            </button>
            <span class="px-4 py-2">Page {{ currentPage }} of {{ totalPages }}</span>
            <button @click="nextPage" :disabled="currentPage === totalPages" class="px-4 py-2 bg-red-600 text-white rounded-r">
                Next
            </button>
        </div>
    </div>
