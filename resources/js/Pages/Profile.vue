<template>
    <div v-if="user" class="bg-gray-100 flex items-center justify-center h-screen">
        ...
        <div class="flex justify-center mb-6">
          <div class="relative">
            <img
              ...
              :src="user.profile_picture ? `/storage/${user.profile_picture}` : 'https://via.placeholder.com/100'"
            />
          ...
          <div class="mb-4">
            ...
            <div class="relative">
              <input
                ...
                placeholder="********"
              />
              <button class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500" type="button">
